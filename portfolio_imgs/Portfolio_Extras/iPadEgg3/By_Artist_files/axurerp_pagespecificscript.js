...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('By_Date.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('By_Nationality.html');

}
});
gv_vAlignTable['u87'] = 'center';gv_vAlignTable['u89'] = 'center';gv_vAlignTable['u91'] = 'top';
u92.style.cursor = 'pointer';
$axure.eventManager.click('u92', function(e) {

if (true) {

	self.location.href=$axure.globalVariableProvider.getLinkUrl('Art_Terms.html');

}
});
gv_vAlignTable['u11'] = 'center';gv_vAlignTable['u13'] = 'center';gv_vAlignTable['u15'] = 'center';gv_vAlignTable['u18'] = 'center';document.getElementById('u113_img').tabIndex = 0;
...
gv_vAlignTable['u114'] = 'center';gv_vAlignTable['u21'] = 'center';gv_vAlignTable['u24'] = 'center';gv_vAlignTable['u26'] = 'center';gv_vAlignTable['u28'] = 'center';gv_vAlignTable['u100'] = 'center';document.getElementById('u101_img').tabIndex = 0;
...
gv_vAlignTable['u106'] = 'center';gv_vAlignTable['u30'] = 'center';gv_vAlignTable['u32'] = 'center';gv_vAlignTable['u34'] = 'center';gv_vAlignTable['u36'] = 'center';gv_vAlignTable['u38'] = 'center';gv_vAlignTable['u94'] = 'center';gv_vAlignTable['u96'] = 'center';document.getElementById('u97_img').tabIndex = 0;
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('Visit.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('Bookmarks.html');

}
});
gv_vAlignTable['u118'] = 'center';gv_vAlignTable['u43'] = 'center';document.getElementById('u44_img').tabIndex = 0;
